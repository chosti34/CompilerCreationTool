...
const std::vector<ActionType> gcActionTypes = {
	...
	ActionType::CreateBinaryEqualsNode,
...
const std::unordered_map<ActionType, std::string> gcActionStringMap = {
	...
	{ ActionType::CreateBinaryEqualsNode, "CreateBinaryEqualsNode" },
...
const std::unordered_map<ActionType, std::string> gcActionPrettyStringMap = {
	...
	{ ActionType::CreateBinaryEqualsNode, "Create binary equals node" },
...
const std::unordered_map<ActionType, std::string> gcActionDescriptionMap = {
	...
	{ ActionType::CreateBinaryEqualsNode, "Pop two last expressions from the expression stack, create binary equals node from them, then push it to the stack" },
