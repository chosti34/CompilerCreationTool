...
{
// Возвращает строковое представление грамматики
...
//  В случае, если указанный нетерминал в одном из своих правил хранит первым символом леворекурсивный нетерминал,
